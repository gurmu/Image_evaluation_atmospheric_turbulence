...
class Simulator(nn.Module): 
    ...
    '''
    def __init__(self, Dr0, img_size, corr = -0.1, data_path = './data', device = 'cpu', scale=1.0, use_temp = False):
        super().__init__()
        ...
        self.mapping = _P2S()
        self.mapping.load_state_dict(torch.load(os.path.join(data_path,'P2S_model.pt'), map_location=torch.device('cpu')))
